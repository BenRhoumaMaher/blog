...
if(isset($_REQUEST['query'])) {
    ...
    $sqlgetsearchresults = "SELECT * FROM blog_tags INNER JOIN blog_post
    ON blog_tags.blog_post_id = blog_post.blog_post_id 
    WHERE blog_tags.tag LIKE '%" . $searchquery . "%' OR blog_post.post_title LIKE '%" . $searchquery . 
    "%'";
    $smt = $dba->prepare($sqlgetsearchresults);
    $smt->execute();
    $qra = $smt->FETCHALL(PDO::FETCH_OBJ);
?>
<!DOCTYPE html>
...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>Maher's Blog | Search</title>
