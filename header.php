...
<header class="s-header">
    ...
    <div class="s-header__logo">
        <a class="logo" href="index.php">
            <h2 style="color:white;font-family:monospace;display:table-cell;padding-top:18">Maher.</h2>
        </a>
    </div>
                ...
                <li class="has-children">
                    ...
                    <ul class="sub-menu">
                        <?php 
                                ...
                                $categoryname = $qrr->category_title;
                                $categorypath = $qrr->category_path;
